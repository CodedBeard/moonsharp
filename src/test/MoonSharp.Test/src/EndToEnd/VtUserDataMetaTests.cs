...
namespace MoonSharp.Interpreter.Tests.EndToEnd
{
	...
	public class VtUserDataMetaTests
	{
		...
		public void VInterop_Meta_Pairs()
		{
			...
			Assert.Equal("aAbBcC", S.DoString(script).String);
		}
		...
		public void VInterop_Meta_Iterator()
		{
			...
			Assert.Equal(6, S.DoString(script).Number);
		}
		...
		public void VInterop_Meta_Op_Len()
		{
			...
			Assert.Equal(55, S.DoString("return #o3").Number);
			Assert.Equal(123, S.DoString("return #o2").Number);
            
			Assert.Throws<ScriptRuntimeException>(() => S.DoString("return #o1"));
		}
		...
		public void VInterop_Meta_Equality()
		{
			...
			Assert.True(S.DoString("return o1 == o1").Boolean, "o1 == o1");
			Assert.True(S.DoString("return o1 != o2").Boolean, "o1 != o2");
			Assert.True(S.DoString("return o1 == o3").Boolean, "o1 == o3");
			Assert.True(S.DoString("return o2 != o3").Boolean, "o2 != o3");
			Assert.True(S.DoString("return o1 == 5 ").Boolean, "o1 == 5 ");
			Assert.True(S.DoString("return 5 == o1 ").Boolean, "5 == o1 ");
			Assert.True(S.DoString("return o1 != 6 ").Boolean, "o1 != 6 ");
			Assert.True(S.DoString("return 6 != o1 ").Boolean, "6 != o1 ");
			Assert.True(S.DoString("return 'xx' != o1 ").Boolean, "'xx' != o1 ");
			Assert.True(S.DoString("return o1 != 'xx' ").Boolean, "o1 != 'xx'");
		}
		...
		public void VInterop_Meta_Comparisons()
		{
			...
			Assert.True(S.DoString("return o2 > o1 ").Boolean, "o2 > o1 ");
			Assert.True(S.DoString("return o2 >= o1").Boolean, "o2 >= o1");
			Assert.True(S.DoString("return o2 >= o2").Boolean, "o2 >= o2");

			Assert.True(S.DoString("return o1 <= 4 ").Boolean, "o1 <= 4 ");
			Assert.True(S.DoString("return o1 <  4 ").Boolean, "o1 <  4 ");

			Assert.True(S.DoString("return 4 > o1  ").Boolean, "4 > o1  ");
			Assert.True(S.DoString("return 4 >= o1 ").Boolean, "4 >= o1 ");

			Assert.False(S.DoString("return o1 > o2 ").Boolean, "o1 > o2 ");
			Assert.False(S.DoString("return o1 >= o2").Boolean, "o1 >= o2");
			Assert.False(S.DoString("return o2 < o1 ").Boolean, "o2 < o1 ");
			Assert.False(S.DoString("return o2 <= o1").Boolean, "o2 <= o1");
		}
