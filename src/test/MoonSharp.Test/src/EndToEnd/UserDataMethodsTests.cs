...
namespace MoonSharp.Interpreter.Tests.EndToEnd
{
	...
	public class UserDataMethodsTests
	{
		...
		public void Test_VarArgs(InteropAccessMode opt)
		{
			...
			Assert.Equal("1.2@ciao:True", res.String);
		}
		...
		public void Test_ConcatMethodStaticComplexCustomConv(InteropAccessMode opt)
		{
			try
			{
				...
				Assert.Equal(DataType.String, res.Type);
				Assert.Equal("CIAO,HELLO,ALOHA|42,77,125,13|ALOHA,CIAO,HELLO|39,78,128|CIAO,HELLO,ALOHA|43,78,126,14", res.String);
			}
			finally
			{
				Script.GlobalOptions.CustomConverters.Clear();
		...
		public void Test_ConcatMethodStaticComplex(InteropAccessMode opt)
		{
			...
			Assert.Equal(DataType.String, res.Type);
			Assert.Equal("ciao,hello,aloha|42,77,125,13|aloha,ciao,hello|39,78,128|ciao,hello,aloha|42,77,125,13", res.String);
		}
		...
		public void Test_ConcatMethodStaticComplexRec(InteropAccessMode opt)
		{
			...
			Assert.Equal(DataType.String, res.Type);
			Assert.Equal("1,2,3|11,35,77|16,42,64|99,76,17|", res.String);
		}
		...
		public void Test_RefOutParams(InteropAccessMode opt)
		{
			...
			Assert.Equal("CiAohello", res.Tuple[1].String);
		...
		public void Test_ConcatMethodStatic(InteropAccessMode opt)
		{
			...
			Assert.Equal(DataType.String, res.Type);
			Assert.Equal("eheh1ciao!SOMECLASS!True|asdqwezxc|asdqwezxc|123xy|asdqweXYzxc|!SOMECLASS!1994", res.String);
		}
		...
		public void Test_ConcatMethod(InteropAccessMode opt)
		{
			...
			Assert.Equal(DataType.String, res.Type);
			Assert.Equal("eheh1ciao!SOMECLASS!True|asdqwezxc|asdqwezxc|123xy|asdqweXYzxc|!SOMECLASS!1912", res.String);
		}
		...
		public void Interop_DualInterfaces()
		{
			...
			Assert.Equal(DataType.String, res.Type);
			Assert.Equal("Test1Test2", res.String);
		}
		...
		public void Interop_StaticInstanceAccessRaisesError()
		{
			...
			{
				Assert.True(ex.Message.Contains("attempt to access instance member"));
			}
		}
