	...
	public class CollectionsBaseGenRegisteredTests
	{
		...
		public void RegCollGen_List_ExtMeth_Last()
		{
			...
			",
			 (r) =>
			 {
				 Assert.Equal(DataType.Number, r.Type);
		...
		public void RegCollGen_IteratorOnList_ChangeElem()
		{
			...
			",
			 ...
			 {
				 Assert.Equal(DataType.Number, r.Type);
				 Assert.Equal(9, r.Number);
				 Assert.Equal(1, o.GetList()[0]);
				 Assert.Equal(5, o.GetList()[1]);
				 Assert.Equal(3, o.GetList()[2]);
			 });
		}
		...
		public void RegCollGen_IteratorOnArray_ChangeElem()
		{
			...
			",
			 (r, o) =>
			 {
				 ...
				 Assert.Equal(2, o.GetArray()[0]);
				 Assert.Equal(5, o.GetArray()[1]);
				 Assert.Equal(6, o.GetArray()[2]);
			 });
		}
		...
		public void RegCollGen_IteratorOnMultiDimArray_ChangeElem()
		{
			...
			",
			 ...
			 {
				 Assert.Equal(DataType.Number, r.Type);
				 Assert.Equal(41, r.Number);
				 Assert.Equal(2, o.GetMultiArray()[0, 0]);
				 Assert.Equal(9, o.GetMultiArray()[0, 1]);
				 Assert.Equal(6, o.GetMultiArray()[0, 2]);
				 Assert.Equal(7, o.GetMultiArray()[1, 0]);
				 Assert.Equal(8, o.GetMultiArray()[1, 1]);
				 Assert.Equal(9, o.GetMultiArray()[1, 2]);
			 });
		}
		...
		public void RegCollGen_IteratorOnObjList_ChangeElem()
		{
			...
			",
			 ...
			 {
				 Assert.Equal(DataType.Number, r.Type);
				 Assert.Equal(7 + 17 + 9, r.Number);
				 Assert.Equal(7, o.GetItems()[0].Value);
				 Assert.Equal(17, o.GetItems()[1].Value);
				 Assert.Equal(9, o.GetItems()[2].Value);
			 });
		}
