...
namespace MoonSharp.Interpreter.Tests.EndToEnd
{
	...
	public class TableTests
	{
		...
		public void TableAccessAndCtor()
		{
			...
			Assert.Equal(7, res.Tuple.Length);
			...
			Assert.Equal(DataType.Number, res.Tuple[5].Type);
			Assert.Equal(DataType.Number, res.Tuple[6].Type);
			Assert.Equal(1, res.Tuple[0].Number);
			Assert.Equal(2, res.Tuple[1].Number);
			Assert.Equal(3, res.Tuple[2].Number);
			Assert.Equal(4, res.Tuple[3].Number);
			Assert.Equal(5, res.Tuple[4].Number);
			Assert.Equal(6, res.Tuple[5].Number);
			Assert.Equal(7, res.Tuple[6].Number);
		}
		...
		public void TableMethod6()
		{
			...
			Assert.Equal(true, res.CastToBool());
		}
		...
		public void TableNextWithChangeInCollection()
		{
			...
			Assert.Equal("1|2|3|4|5", res.String);
		}
		...
		public void TablePairsWithoutMetatable()
		{
			...
			Assert.Equal(DataType.Number, res.Tuple[1].Type);
			Assert.Equal(5, res.Tuple[0].String.Length);
			Assert.Equal(15, res.Tuple[1].Number);
		}
		...
		";
			...
			Assert.Equal("hello", t.Table["ciao"]);
		}
		...
		";
			...
			Assert.Equal("hello", s.Globals["t", "ciao"]);
		}
		...
		";
			...
			Assert.Equal("hello", s.Globals["t", "ciao", 1]);
		}
		...
		public void TestUnpack()
		{
			...
			Assert.Equal(DataType.Tuple, res.Type);
			Assert.Equal(2, res.Tuple.Length);
			Assert.Equal(3, res.Tuple[0].Number);
			Assert.Equal(4, res.Tuple[1].Number);
		}
		...
		";
			...
			Assert.Equal("hello", s.Globals["t", "ciao"]);
			Assert.True(s.Globals.Get("t").Table.OwnerScript == null);
		}
