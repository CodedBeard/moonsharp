...
namespace MoonSharp.Interpreter.Tests.EndToEnd
{
	...
	public class UserDataNestedTypesTests
	{
		...
		public void Interop_NestedTypes_Public_Enum()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.UserData, res.Type);
		}
		...
		public void Interop_NestedTypes_Public_Ref()
		{
			...
			NUnit.Framework.Assert.AreEqual("Ciao from SomeNestedType", res.String);
		}
		...
		public void Interop_NestedTypes_Private_Ref()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("Ciao from SomeNestedTypePrivate", res.String);
		}
		...
		public void Interop_NestedTypes_Private_Ref_2()
		{
            Assert.Throws<ScriptRuntimeException>(() => {
                ...
                NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
                NUnit.Framework.Assert.AreEqual("Ciao from SomeNestedTypePrivate2", res.String);
            });
