...
#pragma warning disable 169 // unused private field
	...
	public class UserDataEventsTests
	{
		...
		public void Interop_Event_Simple()
		{
			...
			NUnit.Framework.Assert.AreEqual(1, invocationCount);
		}
		...
		public void Interop_Event_Multi()
		{
			...
			NUnit.Framework.Assert.AreEqual(2, invocationCount);
		}
		...
		public void Interop_Event_MultiAndDetach()
		{
			...
			NUnit.Framework.Assert.AreEqual(3, invocationCount);
		}
		...
		public void Interop_Event_DetachAndDeregister()
		{
			...
			NUnit.Framework.Assert.IsFalse(obj.Trigger_MyEvent(), "deregistration");
			NUnit.Framework.Assert.AreEqual(3, invocationCount);
		}
		...
		public void Interop_SEvent_DetachAndDeregister()
		{
			...
			NUnit.Framework.Assert.IsFalse(SomeClass.Trigger_MySEvent(), "deregistration");
			NUnit.Framework.Assert.AreEqual(3, invocationCount);
		}
		...
		public void Interop_SEvent_DetachAndReregister()
		{
			...
			NUnit.Framework.Assert.AreEqual(2, invocationCount);
			NUnit.Framework.Assert.IsTrue(SomeClass.Trigger_MySEvent(), "deregistration");
		}
