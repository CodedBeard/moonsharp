...
namespace MoonSharp.Interpreter.Tests.EndToEnd
{
	...
	public class UserDataMetaTests
	{
		...
		public void Interop_Meta_Pairs()
		{
			...
			NUnit.Framework.Assert.AreEqual("aAbBcC", S.DoString(script).String);
		}
		...
		public void Interop_Meta_Iterator()
		{
			...
			NUnit.Framework.Assert.AreEqual(6, S.DoString(script).Number);
		}
		...
		public void Interop_Meta_Op_Len()
		{
			...
			NUnit.Framework.Assert.AreEqual(55, S.DoString("return #o3").Number);
			NUnit.Framework.Assert.AreEqual(123, S.DoString("return #o2").Number);

			NUnit.Framework.Assert.Catch<ScriptRuntimeException>(() => S.DoString("return #o1"));
		}
		...
		public void Interop_Meta_Equality()
		{
			...
			NUnit.Framework.Assert.IsTrue(S.DoString("return o1 == o1").Boolean, "o1 == o1");
			NUnit.Framework.Assert.IsTrue(S.DoString("return o1 != o2").Boolean, "o1 != o2");
			NUnit.Framework.Assert.IsTrue(S.DoString("return o1 == o3").Boolean, "o1 == o3");
			NUnit.Framework.Assert.IsTrue(S.DoString("return o2 != o3").Boolean, "o2 != o3");
			NUnit.Framework.Assert.IsTrue(S.DoString("return o1 == 5 ").Boolean, "o1 == 5 ");
			NUnit.Framework.Assert.IsTrue(S.DoString("return 5 == o1 ").Boolean, "5 == o1 ");
			NUnit.Framework.Assert.IsTrue(S.DoString("return o1 != 6 ").Boolean, "o1 != 6 ");
			NUnit.Framework.Assert.IsTrue(S.DoString("return 6 != o1 ").Boolean, "6 != o1 ");
			NUnit.Framework.Assert.IsTrue(S.DoString("return 'xx' != o1 ").Boolean, "'xx' != o1 ");
			NUnit.Framework.Assert.IsTrue(S.DoString("return o1 != 'xx' ").Boolean, "o1 != 'xx'");
		}
		...
		public void Interop_Meta_Comparisons()
		{
			...
			NUnit.Framework.Assert.IsTrue(S.DoString("return o2 > o1 ").Boolean, "o2 > o1 ");
			NUnit.Framework.Assert.IsTrue(S.DoString("return o2 >= o1").Boolean, "o2 >= o1");
			NUnit.Framework.Assert.IsTrue(S.DoString("return o2 >= o2").Boolean, "o2 >= o2");

			NUnit.Framework.Assert.IsTrue(S.DoString("return o1 <= 4 ").Boolean, "o1 <= 4 ");
			NUnit.Framework.Assert.IsTrue(S.DoString("return o1 <  4 ").Boolean, "o1 <  4 ");

			NUnit.Framework.Assert.IsTrue(S.DoString("return 4 > o1  ").Boolean, "4 > o1  ");
			NUnit.Framework.Assert.IsTrue(S.DoString("return 4 >= o1 ").Boolean, "4 >= o1 ");

			NUnit.Framework.Assert.IsFalse(S.DoString("return o1 > o2 ").Boolean, "o1 > o2 ");
			NUnit.Framework.Assert.IsFalse(S.DoString("return o1 >= o2").Boolean, "o1 >= o2");
			NUnit.Framework.Assert.IsFalse(S.DoString("return o2 < o1 ").Boolean, "o2 < o1 ");
			NUnit.Framework.Assert.IsFalse(S.DoString("return o2 <= o1").Boolean, "o2 <= o1");
		}
		...
		private void OperatorTest(string code, int input, int output)
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, v.Type);
			NUnit.Framework.Assert.AreEqual(output, v.Number);
		}
