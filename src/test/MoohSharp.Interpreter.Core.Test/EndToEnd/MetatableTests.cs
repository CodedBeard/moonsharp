...
namespace MoonSharp.Interpreter.Tests.EndToEnd
{
	...
	public class MetatableTests
	{
		...
		public void TableIPairsWithMetatable()
		{
			...
			NUnit.Framework.Assert.AreEqual("321", res.String);
		}
		...
		public void MetatableEquality()
		{
			...
			NUnit.Framework.Assert.AreEqual(false, res.Tuple[1].Boolean);
		...
		public void MetatableCall2()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(468, res.Number);
		...
		public void MetatableIndexAndSetIndexFuncs()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("abc!bc", res.String);
		}
		...
		public void MetatableExtensibleObjectSample()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(120, res.Number);
		}
