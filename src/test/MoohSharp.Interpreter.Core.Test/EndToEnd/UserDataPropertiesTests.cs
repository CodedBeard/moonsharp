...
namespace MoonSharp.Interpreter.Tests.EndToEnd
{
	...
	public class UserDataPropertiesTests
	{
		...
		public void Test_IntPropertyGetter(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(321, res.Number);
		}
		...
		public void Test_NIntPropertyGetter(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(321.0, res.Tuple[0].Number);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[0].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Nil, res.Tuple[1].Type);
		}
		...
		public void Test_ObjPropertyGetter(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual("ciao", res.Tuple[0].String);
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Tuple[2].Type);
			NUnit.Framework.Assert.AreEqual("ciao", res.Tuple[2].String);
			NUnit.Framework.Assert.AreEqual(DataType.UserData, res.Tuple[1].Type);
			NUnit.Framework.Assert.AreEqual(obj1, res.Tuple[1].UserData.Object);
		}
		...
		public void Test_IntPropertySetter(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(321, obj.IntProp);

			DynValue res = S.DoString(script);

			NUnit.Framework.Assert.AreEqual(19, obj.IntProp);
		}
		...
		public void Test_NIntPropertySetter(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(321, obj1.NIntProp);
			NUnit.Framework.Assert.AreEqual(null, obj2.NIntProp);

			DynValue res = S.DoString(script);

			NUnit.Framework.Assert.AreEqual(null, obj1.NIntProp);
			NUnit.Framework.Assert.AreEqual(19, obj2.NIntProp);
		}
		...
		public void Test_ObjPropertySetter(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual("ciao", obj1.ObjProp);
			NUnit.Framework.Assert.AreEqual(obj1, obj2.ObjProp);

			DynValue res = S.DoString(script);

			NUnit.Framework.Assert.AreEqual(obj2, obj1.ObjProp);
			NUnit.Framework.Assert.AreEqual("hello", obj2.ObjProp);
		}
		...
		public void Test_StaticPropertyAccess(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual("qweqwe", SomeClass.StaticProp);

			DynValue res = S.DoString(script);

			NUnit.Framework.Assert.AreEqual("asdasdqweqwe", SomeClass.StaticProp);
		}
		...
		public void Test_RoIntPropertyGetter(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(5, res.Number);
		}
		...
		public void Test_RoIntProperty2Getter(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(1234, res.Number);
		}
		...
		public void Test_WoIntProperty2Setter(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(19, obj.WoIntProp2);
		}
		...
		public void Test_PropertyAccessOverrides(InteropAccessMode opt)
		{
			...
			{
				NUnit.Framework.Assert.AreEqual(19, obj.AccessOverrProp);
				return;
			}
		...
		public void Interop_IntPropertySetterWithSimplifiedSyntax()
		{
			...
			NUnit.Framework.Assert.AreEqual(obj, S.Globals["myobj"]);
			NUnit.Framework.Assert.AreEqual(19, obj.IntProp);
		}
		...
		public void Interop_OutOfRangeNumber()
		{
			...
			NUnit.Framework.Assert.IsNotNull(v);
		}
