...
namespace MoonSharp.Interpreter.Tests.EndToEnd
{
	...
	public class UserDataMethodsTests
	{
		...
		public void Test_VarArgs(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual("1.2@ciao:True", res.String);
		}
		...
		public void Test_ConcatMethodStaticComplexCustomConv(InteropAccessMode opt)
		{
			try
			{
				...
				NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
				NUnit.Framework.Assert.AreEqual("CIAO,HELLO,ALOHA|42,77,125,13|ALOHA,CIAO,HELLO|39,78,128|CIAO,HELLO,ALOHA|43,78,126,14", res.String);
			}
			finally
			{
				Script.GlobalOptions.CustomConverters.Clear();
		...
		public void Test_ConcatMethodStaticComplex(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("ciao,hello,aloha|42,77,125,13|aloha,ciao,hello|39,78,128|ciao,hello,aloha|42,77,125,13", res.String);
		}
		...
		public void Test_ConcatMethodStaticComplexRec(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("1,2,3|11,35,77|16,42,64|99,76,17|", res.String);
		}
		...
		public void Test_RefOutParams(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual("CiAohello", res.Tuple[1].String);
		...
		public void Test_ConcatMethodStatic(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("eheh1ciao!SOMECLASS!True|asdqwezxc|asdqwezxc|123xy|asdqweXYzxc|!SOMECLASS!1994", res.String);
		}
		...
		public void Test_ConcatMethod(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("eheh1ciao!SOMECLASS!True|asdqwezxc|asdqwezxc|123xy|asdqweXYzxc|!SOMECLASS!1912", res.String);
		}
		...
		public void Test_DelegateMethod(InteropAccessMode opt)
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("1%2", res.String);
		}
		...
		public void Interop_TestAutoregisterPolicy()
		{
			...
			try
			{
				...
				NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
				NUnit.Framework.Assert.AreEqual("Test1", res.String);
			}
			finally
			{
		...
		public void Interop_DualInterfaces()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("Test1Test2", res.String);
		}
		...
		public void Interop_TestNamesCamelized()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(20, res.Number);
		...
		public void Interop_TestSelfDescribingType()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(18, res.Number);
		}
		...
		public void Interop_TestCustomDescribedType()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(24, res.Number);
		}
		...
		public void Interop_StaticInstanceAccessRaisesError()
		{
			...
			{
				NUnit.Framework.Assert.IsTrue(ex.Message.Contains("attempt to access instance member"));
			}
		}
