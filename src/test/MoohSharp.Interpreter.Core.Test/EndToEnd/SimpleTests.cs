...
namespace MoonSharp.Interpreter.Tests.EndToEnd
{
	...
	public class SimpleTests
	{
		...
		public void CSharpStaticFunctionCallStatement()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Void, res.Type);
			NUnit.Framework.Assert.AreEqual(2, args.Count);
			NUnit.Framework.Assert.AreEqual(DataType.String, args[0].Type);
			NUnit.Framework.Assert.AreEqual("hello", args[0].String);
			NUnit.Framework.Assert.AreEqual(DataType.String, args[1].Type);
			NUnit.Framework.Assert.AreEqual("world", args[1].String);
		}
		...
		public void CSharpStaticFunctionCall4()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(1234.0, res.Number);
		}
		...
		public void CSharpStaticFunctionCall2()
		{
			...
			NUnit.Framework.Assert.AreEqual(1, args.Count);
			NUnit.Framework.Assert.AreEqual(DataType.String, args[0].Type);
			NUnit.Framework.Assert.AreEqual("hello", args[0].String);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(1234.0, res.Number);
		...
		public void LongStrings()
		{
			...
			NUnit.Framework.Assert.AreEqual(3, res.Tuple.Length);
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Tuple[0].Type);
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Tuple[1].Type);
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Tuple[2].Type);
			NUnit.Framework.Assert.AreEqual("\t\t\t\t\tciao\n\t\t\t\t", res.Tuple[0].String);
			NUnit.Framework.Assert.AreEqual(" [[uh]] ", res.Tuple[1].String);
			NUnit.Framework.Assert.AreEqual("[==[[=[[[eheh]]=]=]", res.Tuple[2].String);
		}
		...
		public void UnicodeEscapeLua53Style()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("ciaoA", res.String);
		}
		...
		public void KeywordsInStrings()
		{
			...
			DynValue res = Script.RunString(script);
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual(keywrd, res.String);
		}
		...
		public void ParserErrorMessage()
		{
			...
			{
				caught = true;
				NUnit.Framework.Assert.True(!string.IsNullOrEmpty(ex.Message));
			}
		...
		public void FunctionCallWrappers()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(1994, res.Number);
		}
		...
		public void ReturnSimpleUnop()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(-42, res.Number);
		}
		...
		public void FunctionOrOperator()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.ClrFunction, res.Type);
		...
		public void SelectNegativeIndex()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("c", res.String);
		}
		...
		public void BoolConversionAndShortCircuit()
		{
			...
			NUnit.Framework.Assert.AreEqual(5, res.Tuple.Length);
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Tuple[0].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Boolean, res.Tuple[1].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Boolean, res.Tuple[2].Type);
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Tuple[3].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[4].Type);
			NUnit.Framework.Assert.AreEqual("!", res.Tuple[0].String);
			NUnit.Framework.Assert.AreEqual(true, res.Tuple[1].Boolean);
			NUnit.Framework.Assert.AreEqual(false, res.Tuple[2].Boolean);
			NUnit.Framework.Assert.AreEqual("!", res.Tuple[3].String);
			NUnit.Framework.Assert.AreEqual(2, res.Tuple[4].Number);
		}
		[Test]
		...
		public void Factorial()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(120.0, res.Number);
		}
		...
		public void IfStatmWithScopeCheck()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Tuple, res.Type);
			NUnit.Framework.Assert.AreEqual(2, res.Tuple.Length);
			NUnit.Framework.Assert.AreEqual(DataType.Nil, res.Tuple[0].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[1].Type);
			NUnit.Framework.Assert.AreEqual(6, res.Tuple[1].Number);
		}
		...
		public void ForLoopWithBreak()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(1, res.Number);
		}
		...
		public void ForEachLoopWithBreak()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Tuple, res.Type);
			NUnit.Framework.Assert.AreEqual(2, res.Tuple.Length);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[0].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[1].Type);
			NUnit.Framework.Assert.AreEqual(6, res.Tuple[0].Number);
			NUnit.Framework.Assert.AreEqual(12, res.Tuple[1].Number);
		}
		...
		public void ForEachLoop()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[0].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[1].Type);
			NUnit.Framework.Assert.AreEqual(21, res.Tuple[0].Number);
			NUnit.Framework.Assert.AreEqual(42, res.Tuple[1].Number);
		}
		...
		public void LengthOperator()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[0].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[1].Type);
			NUnit.Framework.Assert.AreEqual(4, res.Tuple[0].Number);
			NUnit.Framework.Assert.AreEqual(3, res.Tuple[1].Number);
		}
		...
		public void VeryBasic()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(7, res.Number);
		}
		...
		public void OperatorAssociativity()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(512, res.Number);
		}
		...
		public void OperatorPrecedence3()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(0, res.Number);
		}
		...
		public void OperatorPrecedence4()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(2, res.Number);
		}
		...
		public void OperatorPrecedence5()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(12, res.Number);
		}
		...
		public void OperatorPrecedence6()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(-4, res.Number);
		}
		...
		public void OperatorPrecedence7()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(-14, res.Number);
		}
		...
		public void OperatorPrecedenceAndAssociativity()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(528, res.Number);
		}
		...
		public void OperatorParenthesis()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(110, res.Number);
		}
		...
		public void TupleAssignment1()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(6, res.Number);
		}
		...
		public void SimpleForLoop()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(6.0, res.Number);
		}
		...
		public void SimpleFunc()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(3, res.Number);
		}
		...
		public void LocalFunctionsObscureScopeRule()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Function, res.Type);
		}
		...
		public void FunctionWithStringArg2()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("ciao", res.String);
		}
		...
		public void FunctionWithTableArg()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Table, res.Type);
		...
		public void TupleAssignment2()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[0].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[1].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[2].Type);
			NUnit.Framework.Assert.AreEqual(1, res.Tuple[0].Number);
			NUnit.Framework.Assert.AreEqual(1, res.Tuple[1].Number);
			NUnit.Framework.Assert.AreEqual(2, res.Tuple[2].Number);
		}
		[Test]
		...
		public void ExpressionReducesTuples2()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Tuple, res.Type);
			NUnit.Framework.Assert.AreEqual(4, res.Tuple.Length);
		}
		...
		public void ArgsDoNotChange()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[1].Type);
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Tuple[2].Type);
			NUnit.Framework.Assert.AreEqual(11, res.Tuple[0].Number);
			NUnit.Framework.Assert.AreEqual(1, res.Tuple[1].Number);
			NUnit.Framework.Assert.AreEqual(2, res.Tuple[2].Number);
		}
		...
		public void VarArgsSum()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(10, res.Number);
		}
		...
		public void VarArgsSum2()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Number, res.Type);
			NUnit.Framework.Assert.AreEqual(50, res.Number);
		}
		...
		public void SwapPattern()
		{
			...
			NUnit.Framework.Assert.AreEqual(3, res.Tuple[1].Number);
			NUnit.Framework.Assert.AreEqual(2, res.Tuple[2].Number);
			NUnit.Framework.Assert.AreEqual(1, res.Tuple[3].Number);
		}
		...
		public void EnvTestSuite()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Boolean, T.Get("T1").Type, "T1-Type");
			NUnit.Framework.Assert.AreEqual(true, T.Get("T1").Boolean, "T1-Val");

			NUnit.Framework.Assert.AreEqual(DataType.Boolean, T.Get("T2").Type, "T2-Type");
			NUnit.Framework.Assert.AreEqual(true, T.Get("T2").Boolean, "T2-Val");

			NUnit.Framework.Assert.AreEqual(DataType.Number, T.Get("T3").Type, "T3-Type");
			NUnit.Framework.Assert.AreEqual(1, T.Get("T3").Number, "T3-Val");

			NUnit.Framework.Assert.AreEqual(DataType.Nil, T.Get("T4").Type, "T4");

			NUnit.Framework.Assert.AreEqual(DataType.Number, T.Get("T5").Type, "T5-Type");
			NUnit.Framework.Assert.AreEqual(2, T.Get("T5").Number, "T5-Val");

			NUnit.Framework.Assert.AreEqual(DataType.Number, T.Get("T6").Type, "T6-Type");
			NUnit.Framework.Assert.AreEqual(3, T.Get("T6").Number, "T6-Val");
		}
		...
		public void TupleToOperator()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.Boolean, res.Type);
			NUnit.Framework.Assert.AreEqual(true, res.Boolean);
		}
		...
		public void LiteralExpands()
		{
			...
			NUnit.Framework.Assert.AreEqual(DataType.String, res.Type);
			NUnit.Framework.Assert.AreEqual("aABCz", res.String);
		}
		...
		public void VarArgsInNoVarArgsReturnsError()
		{
			string script = @"
					...
					return x(1,2,3,4);
								";
            Assert.Throws<SyntaxErrorException>(() => { DynValue res = Script.RunString(script); });
		...
		public void HexFloats_1()
		{
			...
			NUnit.Framework.Assert.AreEqual((double)0x1E / (double)0x100, result.Number);
		}
		...
		public void HexFloats_2()
		{
			...
			DynValue result = Script.RunString(script);
			NUnit.Framework.Assert.AreEqual((double)0xA23 / 16.0, result.Number);
		}
		...
		public void HexFloats_3()
		{
			...
			DynValue result = Script.RunString(script);
			NUnit.Framework.Assert.AreEqual((1 + (double)0x921FB54442D18 / (double)0x10000000000000) * 2, result.Number);
		}
		...
		public void Simple_Delegate_Interop_1()
		{
			...
			NUnit.Framework.Assert.AreEqual(5, a);
		}
